...
namespace Microsoft.PrivacyServices.NgpProxy.PcfDataAgent
{
    ...
    {
        private const string OperationName = "NgpProxyPcfDataAgent";
        ...
        internal static void Main(string[] args)
        {
            ...
            HostDecorator syntheticPcfReceiverDecorator = new PcfDataAgentDecorator(configurationManager.PcfDataAgentConfig, certificateProvider, logger);
            HostDecorator removeConsoleLogger = new RemoveConsoleLoggerDecorator(configurationManager.PcfDataAgentConfig.EnableConsoleLogging);
