namespace Microsoft.PrivacyServices.AzureFunctions.FunctionalTests
{
    ...
    /// </summary>
    [TestClass]
    public class UpdateApprovedVariantRequestTests
    {
        private const string ComponentName = nameof(UpdateApprovedVariantRequestTests);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateApprovedVariantRequestTests"/> class.
        /// </summary>
        public UpdateApprovedVariantRequestTests()
        {
        ...
        /// <summary>
        /// Test whether the function is called when a variant request is approved.
        /// </summary>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [TestMethod]
        public async Task CheckForUpdateApprovedWorkItemSuccessAsync()
        {
            ...
            try
            {
                ...
                // Set the state to CELA Approved
                ...
                string fcnUrl = "admin/functions/UpdateApprovedVariantRequest";
                ...
                while (retryCount++ < 10 && state != "Approved");

                // Verify that the state is Approved
                Assert.AreEqual("Approved", state, "State set to Approved");
            ...
            finally
            {
                ...
                try
                {
                    ...
                    // Delete the variant request (and any other resources) that we created
