/**
 * This file is provided by the document DB teams to enable intellisense.
 * You can read more about it here: https://github.com/Azure/azure-documentdb-js-server/tree/master/utils
 */
//---------------------------------------------------------------------------------------------------
 ...
 * @property {Boolean} isAllowed                             -         True if the query has been queued, false if it is not queued because of a pending timeout. 
 * @memberof Collection
 *
*/
