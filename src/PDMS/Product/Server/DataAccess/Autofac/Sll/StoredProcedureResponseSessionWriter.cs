namespace Microsoft.PrivacyServices.DataManagement.DataAccess.Autofac.Sll
{
    ...
    public class StoredProcedureResponseSessionWriter<T> : BaseSessionWriter<Tuple<string, StoredProcedureResponse<T>>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredProcedureResponseSessionWriter{T}" /> class.
        /// </summary>
        /// <param name="log">The log object.</param>
        /// <param name="properties">The session properties.</param>
        public StoredProcedureResponseSessionWriter(ILogger<Base> log, SessionProperties properties) : base(log, properties)
        {
        }
        ...
        public override void WriteDone(SessionStatus status, string name, long totalMilliseconds, string cv, Tuple<string, StoredProcedureResponse<T>> data)
        {
