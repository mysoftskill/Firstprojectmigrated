namespace Microsoft.PrivacyServices.DataManagement.DataAccess.Autofac.Sll
{
    ...
    public class FeedResponseSessionWriter<T> : BaseSessionWriter<Tuple<string, FeedResponse<T>>>
        where T : Resource, new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedResponseSessionWriter{T}" /> class.
        /// </summary>
        /// <param name="log">The log object.</param>
        /// <param name="properties">The session properties.</param>
        public FeedResponseSessionWriter(ILogger<Base> log, SessionProperties properties) : base(log, properties)
        {
        }
        ...
        public override void WriteDone(SessionStatus status, string name, long totalMilliseconds, string cv, Tuple<string, FeedResponse<T>> data)
        {
