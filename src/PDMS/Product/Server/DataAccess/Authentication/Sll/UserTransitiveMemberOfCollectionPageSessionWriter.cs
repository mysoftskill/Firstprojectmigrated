namespace Microsoft.PrivacyServices.DataManagement.DataAccess.Authentication
{
    ...
    /// <summary>
    /// Logs the successful result data for UserTransitiveMemberOf.
    /// </summary>
    public class UserTransitiveMemberOfCollectionPageSessionWriter : BaseSessionWriter<IUserTransitiveMemberOfCollectionWithReferencesPage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTransitiveMemberOfCollectionPageSessionWriter" /> class.
        /// </summary>
        /// <param name="log">The log object.</param>
        /// <param name="properties">The session properties.</param>
        public UserTransitiveMemberOfCollectionPageSessionWriter(ILogger<Base> log, SessionProperties properties) : base(log, properties)
        {
        }
        ...
        public override void WriteDone(SessionStatus status, string name, long totalMilliseconds, string cv, IUserTransitiveMemberOfCollectionWithReferencesPage data)
        {
