namespace Microsoft.PrivacyServices.DataManagement.Client
{
    ...
    /// <summary>
    /// Converts the ResponseError JSON value into a concrete object.
    /// </summary>
    public class ResponseErrorConverter : JsonConverter
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes the JSON data into a ResponseError.
        /// </summary>
        /// <param name="reader">The JSON reader.</param>
        /// <param name="objectType">The parameter is not used.</param>
        /// <param name="existingValue">The parameter is not used.</param>
        /// <param name="serializer">The parameter is not used.</param>
        /// <returns>The parsed ResponseError.</returns>
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            var data = this.GetObject(reader)["error"] as IDictionary<string, object>;
