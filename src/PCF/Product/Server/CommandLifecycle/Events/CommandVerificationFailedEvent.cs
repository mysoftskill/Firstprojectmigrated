...
{
    /// <summary>
    /// Published when an agent has marked a command as 'VerificationFailed'.
    /// </summary>
    public class CommandVerificationFailedEvent : CommandLifecycleEvent
    {
        public const string Name = "CommandVerificationFailed";
