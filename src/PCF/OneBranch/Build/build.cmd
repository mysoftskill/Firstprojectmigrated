...
set SOLUTION_FILE="%REPO_ROOT_DIR%\src\PCF\Product\CommandFeed.sln"

:: Build the solution
msbuild %PCF_COMPILER_DEF% /p:ForcePackageTarget=true /p:Configuration=%BUILD_CONFIG% /p:Platform=x64 /m /flp:LogFile=build.log;WarningsOnly;ErrorsOnly %SOLUTION_FILE% || exit /b 1
