namespace BloomFilter
{
	...
	public class Filter<T>
	{
		...
		private static float BestErrorRate(int capacity)
		{
			...
			// default
			// https://www.cs.princeton.edu/courses/archive/spring02/cs493/lec7.pdf
		...
		/// <summary>
		/// Hashes a string using Bob Jenkin's "One At A Time" method from Dr. Dobbs (https://burtleburtle.net/bob/hash/doobs.html).
