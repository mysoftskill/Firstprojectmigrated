...
contract AccountCloseAppMultipleResponders  is WorkbenchBase('AccountCloseAppMultipleResponders', 'AccountCloseAppMultipleResponders') {
    ...
    function AccountCloseAppMultipleResponders(string aadObjectId, string aadTenantId, string orgIdPuid) public
    {
