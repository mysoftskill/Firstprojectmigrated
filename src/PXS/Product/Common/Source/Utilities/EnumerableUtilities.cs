...
namespace Microsoft.Membership.MemberServices.Common
{
    ...
    /// <summary>
    ///     A helper class for enumerable collections.
    /// </summary>
    public static class EnumerableUtilities
    {
        ...
        /// <summary>
        ///     Makes a new enumerable from the source enumerable based on a particular property of each element.
        /// </summary>
        /// <typeparam name="T">Enumerable type</typeparam>
        /// <typeparam name="TK">Enumerable key type</typeparam>
        /// <param name="enumerable">Enumerable to distinct by the keyfunc.</param>
        /// <param name="keyFunc">Function to extract the key to distinct by for each element.</param>
        public static IEnumerable<T> DistinctBy<T, TK>(this IEnumerable<T> enumerable, Func<T, TK> keyFunc)
        {
