...
namespace Microsoft.PrivacyServices.DataMonitor.Runner
{
    ...
    {
        private readonly IDataActionRunnerConfig appConfig;
        ...
        {
            this.logger.Information(nameof(TaskSetManager), "Agent watcher worker task manager starting");
            ...
            {
                this.logger.Information(nameof(TaskSetManager), "Agent watcher worker task manager terminating");
            }
        }
