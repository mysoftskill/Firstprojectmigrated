...
namespace Microsoft.Membership.MemberServices.Privacy.RecurrentDeleteWorker
{
    ...
    public sealed class DependencyManager : IDisposable, IDependencyManager
    {
        /// <summary>
        ///     Registration name for the RecurrentDeleteScheduleWorker
        /// </summary>
        internal const string RecurrentDeleteScheduleWorker = "RecurrentDeleteScheduleWorker";

        /// <summary>
        ///     Registration name for the RecurrentDeleteScheduleWorker
        /// </summary>
        internal const string RecurrentDeleteScheduleScanner = "RecurrentDeleteScheduleScanner";

        /// <summary>
        ///     Registration name for the PreVerifierScanner
        /// </summary>
        internal const string PreVerifierScanner = "PreVerifierScanner";

        /// <summary>
        ///     Registration name for the PreVerifierWorker
        /// </summary>
        internal const string PreVerifierWorker = "PreVerifierWorker";
        ...
        {
            DualLogger.Instance.Information(nameof(DependencyManager), "UpdateActiveContainer");
            lock (this.syncLock)
            {
                ...
                {
                    DualLogger.Instance.Information(nameof(DependencyManager), "UpdateActiveContainer...dataManagementConfiguration not null");
        ...
        private void RegisterConfigurationDependentSingletons(IPrivacyConfigurationManager currentConfiguration)
        {
            ...
            this.container.RegisterType<IWorker, RecurrentDeleteScheduleWorkersCollection>(RecurrentDeleteScheduleWorker, new HierarchicalLifetimeManager());
            this.container.RegisterType<IWorker, RecurrentDeleteScheduleScannersCollection>(RecurrentDeleteScheduleScanner, new HierarchicalLifetimeManager());
            this.container.RegisterType<IWorker, PreVerifierScannerCollection>(PreVerifierScanner, new HierarchicalLifetimeManager());
            this.container.RegisterType<IWorker, PreVerifierWorkerCollection>(PreVerifierWorker, new HierarchicalLifetimeManager());
