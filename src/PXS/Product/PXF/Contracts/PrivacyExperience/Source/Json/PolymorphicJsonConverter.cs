// <copyright file="PolymorphicJsonConverter.cs" company="Microsoft Corporation">
    ...
    internal class PolymorphicJsonConverter<TInterface> : JsonConverter
    {
        ...
        public PolymorphicJsonConverter()
        {
            ...
            foreach (var item in derivedTypes)
            {
                ...
                var attribute = GetAttribute(item.Type);
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            try
            {
                ...
                var typeProperty = @object.Property(JsonTypeNameProperty).Value.Value<string>();
        ...
        private static AllowSerializationAttribute GetAttribute(Type type)
        {
            ...
            if (attribute == null)
            {
                throw new InvalidOperationException($"Type: {type.Name} implemented interface {typeof(TInterface).Name} but did not have [{nameof(AllowSerializationAttribute)}] attribute.");
            }
