...
namespace Microsoft.Membership.MemberServices.Privacy.ExperienceContracts
{
    ...
    public class PrivacyRequestStatus
    {
        ...
        /// </summary>
        public ExportArchivesDeleteStatus ExportArchivesDeleteStatus { get; }
        ...
        public PrivacyRequestStatus(
            ...
            ExportArchivesDeleteStatus exportArchivesDeleteStatus = ExportArchivesDeleteStatus.DeleteNotRequested)
        {
            this.Id = id;
            ...
            this.ExportArchivesDeleteStatus = requestType != PrivacyRequestType.Export ? ExportArchivesDeleteStatus.NotApplicable : exportArchivesDeleteStatus; ;
        }
    }
}
