...
namespace Microsoft.Membership.MemberServices.Privacy.ExperienceContracts.V2
{
    ...
    /// <summary>
    ///     The card representing a surround video consumption event
    /// </summary>
    public class SurroundVideoConsumptionCard : ContentConsumptionCard
    {
        /// <summary>
        ///     Build a card from serialized key components
        /// </summary>
        public static SurroundVideoConsumptionCard FromKeyComponents(IDictionary<string, string> components)
        {
            if (components == null)
            ...
            return new SurroundVideoConsumptionCard(mediaId, null, null, null, null, null, null, TimeSpan.Zero, null, timestamp, null, null);
        }
        ...
        public SurroundVideoConsumptionCard(
            string mediaId,
            string title,
            string show,
            string studio,
        ...
        [JsonConstructor]
        private SurroundVideoConsumptionCard(
            string mediaId,
            string title,
            string show,
            string studio,
