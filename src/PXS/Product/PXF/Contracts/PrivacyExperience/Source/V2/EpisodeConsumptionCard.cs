...
namespace Microsoft.Membership.MemberServices.Privacy.ExperienceContracts.V2
{
    ...
    /// <summary>
    ///     The card representing an episode consumption event
    /// </summary>
    public class EpisodeConsumptionCard : ContentConsumptionCard
    {
        /// <summary>
        ///     Build a card from serialized key components
        /// </summary>
        public static EpisodeConsumptionCard FromKeyComponents(IDictionary<string, string> components)
        {
            if (components == null)
            ...
            return new EpisodeConsumptionCard(mediaId, null, null, null, null, null, null, TimeSpan.Zero, null, timestamp, null, null);
        }
        ...
        [JsonConstructor]
        private EpisodeConsumptionCard(
            string mediaId,
            string title,
            string show,
            string studio,
