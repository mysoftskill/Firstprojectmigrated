namespace Microsoft.Membership.MemberServices.PrivacyExperience.SyntheticsTests.RemovePersonalDataSyntheticsJob
{
    using System;
    ...
    /// <summary>
    /// Synthetic job which implements synthetics platform interface to test the RemovePersonalData Graph Api.
    /// </summary>
    public class RemovePersonalDataSyntheticsJob : ISyntheticJob, IDisposable
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="environment">Synthetics environment, will be automatically injected by runtime</param>
        public RemovePersonalDataSyntheticsJob(ISyntheticsEnvironment environment)
        {
        ...
        /// This is the entry point for the RemovePersonalData test code.
        /// </summary>
        ...
        public async Task RunAsync(IReadOnlyDictionary<string, string> parameters)
        {
            ...
            {
                TelemetryClient.TrackTrace("RemovePersonalDataSyntheticsJob RunAsync method started!", SeverityLevel.Information);
                ...
                try
                {
                    RemovePersonalDataConfig config = new RemovePersonalDataConfig(TelemetryClient, parameters);

                    await RemovePersonalDataTask.RunAsync(TelemetryClient, config);
                }
                catch (Exception e)
                {
                ...
                TelemetryClient.TrackTrace("RemovePersonalDataSyntheticsJob RunAsync method finished!", SeverityLevel.Information);
